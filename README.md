...
### Krótki opis
 Na daną chwilę stworzone są wszystkie 3 moduły aplikacji w wersji podstawowej(klient w JavaScript, serwer w Pythonie oraz logika w C++) oraz komunikacja pomiędzy nimi. Klient pobiera skąd oraz dokąd dana figura ma być przemieszczona i wysyła te informacje za pomocą REST do serwera. Następnie serwer wykorzystując Boost::Python i dynamiczną bibliotekę z plikami cpp sprawdza poprawność danego ruchu i odsyła tę informację do klienta. <br/>
